...
# Introduction
## Goal
Canada has always been a vibrant democracy which is solely to the people, for the people, and by the people. Canada’s Egalitarian approach to Democracy has particularly made sure that during any form of decision making in the government at any level, the above statement is given the utmost importance. At the heart of Canadian Democracy and, more specifically, Canadian decision making lies the Federal election during which a general vote is held to elect the people who will make decisions for Canada’s future: the members of Parliament. Under the Canadian law, the federal elections are scheduled every four years during which election races are held in electoral districts to represent the people living in that area. There are a total of 338 electoral districts with the most being present in Ontario. \
...
## Background
The first Canadian federal election was held in 1867, and after Bill C-16 was proclaimed into the law, federal elections have been regularly occuring every four years in most provinces**[1][2]**. Elections Canada hires nearly 250,000 people all over Canada during the federal elections making it the largest employer in Canada on election day **[3]**. \
...
## Significane
As touched upon earlier, the federal election lies at the heart of Canadian democracy and decision making. Once the votes are counted, Canadians, essentially, learn who their government will be**[5]**.
Being such an important event for all residents of Canada and also to people outside Canada to a certain degree, it is of prime importance to have quality research done on the federal elections for the continued  functioning of a healthy democracy. Research done on federal elections can not only reveal existing traits about the political preferences, but also future political preferences of Canadians, which is what this study is aimed at answering. Results of this study can be used by political parties to get an estimate of their standing in the future to plan upcoming campaigns and common Canadians can use this study to get a greater understanding of the popular political parties and their policies. \
...
The journey of Data cleaning started by reducing the number of columns in GCC from 50 to 7 to only include the ones that are needed for the model building. These variables of interest are discussed in the section “description of important variables” which is right below. The reduction of columns was achieved through using the select() function. 
Next, it was decided to merge \
\tab column # 3: place_birth_macro_region which contained birthplace regions of participants born outside Canada \
\tab column # 4: place_birth_province which contained the Province the participants were born in. \
...
Lastly, all the NAs were then dropped from our modified GCC using the na.omit() function.

## Data                          ##### to be combined 
For the people who were not born in Canada, we put in the country they were born in as their place of birth instead of the province as we did for Candian born residents. 
We approximated the age of the residents to the nearest decimal point so as to keep the data consistent with the survey data.
Education -> Trade certificate



## Dataset Syncing
Since two different surveys were being used for the study, syncing had to be performed between the GCC and the CES dataset to move forward. The syncing process began with re-categorising answers from the column containing the education level of the participant in our modified GCC so that it matched the categories of the column containing the level of education of the participant in the CES dataset. This was done using the replace() function (add more about how replaced was used). Next, all the decimal points from age in our modified GCC were dropped to match the format of age in CES. This was done through inserting the column containing age inside the floor() function. Lastly, all the columns in our modified GCC for which we couldn’t find equivalent columns in CES were dropped using the select() function. \
...
Ekos Research Associates is a Canadian research company that measured males are almost equally inclined to vote for Liberal as they are for Conservatives. More specifically, 37% of males have intended to vote for Conservatives and 35% had intentions to vote Liberal [same url below]. This is to say that if the voting population consisted of just Males there would be a tie between the Liberal and Conservatives. On the other hand, Ekos reported that 47% of females were in favour of Liberals and only 23% were in favor of the Conservatives
**[https://www.macleans.ca/politics/ottawa/the-biggest-divide-in-canadian-politics-men-vs-women/]**.  Thus, it can be seen that sex definitely has a huge impact on voting behaviour as male and females differ between their political preferences. \
The age of the electoral population matters a great deal as it has been hypothesized that younger people are more likely to vote for liberal in comparison to older people **[ https://research.libraries.wsu.edu/xmlui/handle/2376/4982 ]**.  Accordingly, the prediction of the popular vote can be greatly influenced by age depending on the size of the different age groups.
Similarly, the education level of the voters can impact the voter turnout as those with a university degree are 78% likely to vote whereas the voting rate for those with high school education or less is 60%**[ https://www150.statcan.gc.ca/n1/pub/75-001-x/2012001/article/11629-eng.htm ]**. \
Additionally, it has been recorded that families with higher income levels have a greater voter turnout in comparison to those who come from families with a lower income[ same as below]. A possible reason for this is due to how costly an activity voting may be as it requires time, information, transportation, and other things that may be inconvenient for lower income families [ same as below].  Furthermore, higher income could be associated with higher education and once again this would influence voting results as mentioned previously **[ https://econofact.org/voting-and-income#:~:text=Voter%20participation%20increases%20with%20family%20income.&text=The%20ratio%20of%20differences%20across,be%20more%20likely%20to%20vote. ]**. \
...
##SHOW THE NUMBER FOR EACH PROVIENCE##
...
\newpage
Note that to make the bins and have a healthy number of people in each bin we ended up grouping people in different age groups instead of leaving them as it is. Hence we ended up with grouping the different ages, the age groups were based on the standard age groups in canada these are as follows.**[https://www.statista.com/statistics/444858/canada-resident-population-by-gender-and-age-group/]**
The age groups were, People under 18; "Under 18", people between 18 and 24; "18 to 24 years", people between 25 to 44; "25 to 44 years", people between 45 and 64; "45 to 64 years" and people over; "Over 65". \


**Removing for this feeling life, religion participation...**



#### POST STRAT Function used
