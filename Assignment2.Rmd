...
#Model ideas
```{r}
## make stratas based on province for

## make simple estimated regression regression model with FPC

## apply the result on the stratas from step 1 

                        ## refrence STA304-MRPs-Updated.pdf
